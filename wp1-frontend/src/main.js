...
const routes = [
	...
	},
	{
		...
		meta: {
			title: (route) => BASE_TITLE + " - Manual Update - " + route.params.projectName,
		},
	},
	{
	...
	},
	{
		...
		meta: {
			title: (route) => BASE_TITLE + " - " + route.params.projectName + " articles",
		},
	},
	{
		path: "/compare/",
...
// Export router for Cypress component tests
export { router };
